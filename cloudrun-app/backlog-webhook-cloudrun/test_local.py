#!/usr/bin/env python3
"""
Local Test Script for Webhook Message Processing Logic
Tests the message extraction and formatting without actual HTTP requests
"""
...
def main():
    ...
    logger.info("🧪 Starting Local Tests for Webhook Message Processing")
    ...
    logger.info(f"\n🎯 Overall Local Tests: {'✅ ALL PASSED' if all_passed else '❌ SOME FAILED'}")
